...
<body>
  ...
  <div class="container">
		<div class="mainBanner">
            <ul id="bannerImg">
			<li class="slideImg"><a href="#"><img src="/img/KimMinji/main_01.png"></a></li>
			<li class="slideImg"><a href="#"><img src="/img/KimMinji/main_02.png"></a></li>
			<li class="slideImg"><a href="#"><img src="/img/KimMinji/main_03.png"></a></li>
			<li class="slideImg"><a href="#"><img src="/img/KimMinji/main_04.png"></a></li>
        </ul>
      </div>
      	<div id="goodsWrap">
      	<div id="goodsTitle">
     ...
     <div class="btnWrap" ><button class="moreBtn"  currentCount="6" totalCount="${rewardTotal }" value="7" id="more">리워드 프로젝트 더보기</button></div>
      	...
      	<div id="noticeWrap">
      	<div id="noticeTitle">
      	<h1><a href="/noticeList">공지사항<img src="/img/KimMinji/right.png" width="20px;"></a></h1>
     ...
     <div class="btnWrap" ><button class="moreBtn" currentCount="4" totalCount="${noticeTotal }" value="5" id="moreNotice">새소식 더보기</button></div>
      	...
      	<div id="eventWrap">
      	<div id="eventTitle">
      	<h1><a href="/eventList">이벤트<img src="/img/KimMinji/right.png" width="20px;"></a></h1>
      	<p>구르밍의 이벤트 소식입니다</p>
