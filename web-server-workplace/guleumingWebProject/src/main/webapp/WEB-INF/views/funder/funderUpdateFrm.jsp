			 ...
			 <form action="/funderUpdate" method="post" enctype="multipart/form-data" id="funder_add">
			    <div class="add_right border_a">
                    <table class="table">
                        ...
                        <tr class="table-active">
                            <th>설립일자</th>
                            <td><input type="text" name="openDate" class="input_03" value="" readonly></td>
                        </tr>
                        <tr class="table-active">
                            <th>유사 업종</th>
                            <td>
                        ...
                        <tr class="table-active">
                            <th>문의사항</th>
                            <td>
                                <input type="text" name="boardEmail" class="input_03" placeholder="email을 입력해주세요." value="">
                            </td>
                        </tr>
                        <tr class="table-active">
                            <th>회사 주소</th>
                        ...
                        <tr class="table-active">
                            <th>회사 소개</th>
                            <td>
                                <textarea name="companyIntro" class="textarea_pro">${fb.companyIntroBr}</textarea>
                            </td>
                        </tr>
                        <tr class="table-active">
                        	<th>보유 자격증</th>
