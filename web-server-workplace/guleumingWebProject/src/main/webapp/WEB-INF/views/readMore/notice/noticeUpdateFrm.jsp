...
<body>
	...
	<div class="container">
		...
		<fieldset style="border:none;">
				<legend><h2 class="write-notice">공지사항 수정</h2></legend>
				<hr>
				<table class="table" style="width:100%;">
					...
					<tr class="table-active">
						<!-- <th>제목</th> -->
						<td colspan="3">
							<input type="text" name="noticeTitle" class="notice-title" value="<%=n.getNoticeTitle() %>" autocomplete="off">
						</td>
					</tr>
					<tr class="table-active">
						<!-- <th>작성자</th> -->
						<td>
							<%--  <%=m.getMemberId() %>--%><!-- admin -->
							<input type="hidden" name="noticeWriter" value=1<%--"<%=m.getMemberId()%> "--%>>
						</td>
						<!-- <th>첨부파일</th>
					...
					<tr class="table-active">
						...
						<td colspan="3" style="text-align:left;">
							<textarea id="noticeContent" type="text" name="noticeContent" value=<%=n.getNoticeContent() %>></textarea>
						</td>
					</tr>
					<tr class="table-active">
						<th colspan="4">
							<button type="submit" class="btn">공지사항수정</button>
