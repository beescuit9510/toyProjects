	...
	<div class="container">
		...
		<form action="/noticeWrite" method="post" enctype="multipart/form-data">
			<fieldset style="border:none;">
				<legend><h2 class="write-notice">공지사항 작성</h2></legend>
				<hr>
				<table class="table" style="width:100%;">
					<tr class="table-active">
						<!-- <th>제목</th> -->
						<td colspan="3">
							<input type="text" name="noticeTitle" class="notice-title" placeholder="제목을 입력해 주세요." autocomplete="off">
						</td>
					</tr>
					<tr class="table-active">
						<!-- <th>작성자</th> -->
					...
					<tr class="table-active">
						...
						<td colspan="3" style="text-align:left;">
							<textarea id="noticeContent" type="text" name="noticeContent" ></textarea>
						</td>
					</tr>
					<tr class="table-active">
						<th colspan="4">
							<button type="submit" class="btn">공지사항등록</button>
