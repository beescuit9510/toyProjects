...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
		<a class="navbar-brand" href="/">Byunduck's World</a>
		...
		<div class="collapse navbar-collapse" id="navbarColor01">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item dropdown">
					...
					href="#" role="button" aria-haspopup="true" aria-expanded="false">Menu4</a>
			...
			<%} else { %>
				<a href="/mypage" class="btn btn-secondary my-2 my-sm-0"><%=member.getMemberName() %></a>
				...
				<form action="/login" method="post" name="loginFrm">
					<div class="modal-body">
						<div class="form-group">-
							...
							<input type="text" name="memberId" id="memberId" class="form-control" placeholder="아이디입력">
						</div>
						<div class="form-group">
							<label for="memberPw">아이디</label>
					...
					<div class="modal-footer">
						<a href="/findIdPwFrm">아이디/비밀번호 찾기</a>
					</div>
				</form>
			</div>
		</div>
