 ...
 * Generated at: 2021-10-11 06:57:39 UTC
...
public final class join_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/common/header.jsp", Long.valueOf(1633913668622L));
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("					<a class=\"nav-link\" href=\"/noticeList?reqPage=1\">공지사항</a>\r\n");
      out.write("				</li>\r\n");
      out.write("				<li class=\"nav-item\">\r\n");
      out.write("					<a class=\"nav-link\" href=\"/boardList?reqPage=1\">자유게시판</a>\r\n");
      out.write("				</li>\r\n");
      out.write("				<li class=\"nav-item\">\r\n");
      out.write("					<a class=\"nav-link\" href=\"/ajax\">AJAX</a>\r\n");
      out.write("				</li>\r\n");
...
if(member == null){ 
      ...
      out.write("		<form action=\"/checkId\" name=\"checkIdFrm\" method=\"post\" >\r\n");
      ...
      out.write("				<label class=\"control-label\" for=\"memberId\" style=\"display:block;\">아이디<span id=\"ajaxCheck\"></span></label>\r\n");
      out.write("				<input type=\"text\" name=\"memberId\" id=\"memberId\" class=\"form-control\" \r\n");
      out.write("				style=\"width:90%; display:inline-block;\">\r\n");
      out.write("				<button type=\"button\" id=\"idChk\" class=\"btn btn-secondary\">중복체크</button>\r\n");
      out.write("			</div>\r\n");
      out.write("			<br>\r\n");
      out.write("			<div class=\"from-group\">\r\n");
      out.write("				<label class=\"control-label\" for=\"memberPw\">비밀번호</label>\r\n");
      out.write("				<input type=\"text\" name=\"memberPw\" id=\"memberPw\" class=\"form-control\">\r\n");
      out.write("			</div>\r\n");
      out.write("			<br>\r\n");
      out.write("			<div class=\"from-group\">\r\n");
      ...
      out.write("				<input type=\"text\" name=\"phone\" id=\"phone\" class=\"form-control\" placeholder=\"010-0000-0000\">\r\n");
      out.write("			</div>\r\n");
      out.write("			<br>\r\n");
      out.write("			<div class=\"from-group\">\r\n");
      ...
      out.write("		var memberId = $(this).prev().val();\r\n");
      ...
      out.write("		\r\n");
      out.write("		//아이디 중복 체크 과정을 진행할 새로운창 open;\r\n");
      out.write("		window.open(\"\",\"checkId\",\"left=300, top=300, width=300, height=200\");\r\n");
      out.write("		\r\n");
      out.write("		// 아이디 중복체크 from과 새로 열린 창을 연결;\r\n");
      out.write("		$(\"[name=checkIdFrm]\").attr(\"target\",\"checkId\");\r\n");
      out.write("		\r\n");
      out.write("		//form 태그를 submit;\r\n");
      out.write("		$(\"[name=checkIdFrm]\").submit();\r\n");
      out.write("\r\n");
      out.write("	})\r\n");
      out.write("	\r\n");
      out.write("	\r\n");
      out.write("	$(\"[name=memberId]\").eq(1).keyup(function () {\r\n");
      out.write("		var memberId = $(this).val();\r\n");
      out.write("		var regExp = /[a-z0-9]{4,}/;\r\n");
      out.write("		// 유효성 검사와 중복체크 중 유효성 검사를 먼저해야함\r\n");
      out.write("		// 유효성 검사에서 통과하지 못하면 어처피 데이터베이스 없어 찾아도 없기때문\r\n");
      out.write("		if(regExp.test(memberId)){\r\n");
      out.write("			//중복검사\r\n");
      out.write("			$.ajax({\r\n");
      out.write("				url : \"/ajaxIdCheck\",\r\n");
      out.write("				data :{memberId:memberId},\r\n");
      out.write("				type :\"POST\",\r\n");
      out.write("				success : function (data) {\r\n");
      out.write("					if(data==1){\r\n");
      out.write("						$(\"#ajaxCheck\").html(\"사용중인 아이디 입니다\");\r\n");
      out.write("						$(\"#ajaxCheck\").css(\"color\",\"red\");\r\n");
      out.write("					}else{\r\n");
      out.write("						$(\"#ajaxCheck\").html(\"사용가능한 아이디 입니다\");\r\n");
      out.write("						$(\"#ajaxCheck\").css(\"color\",\"blue\");						\r\n");
      out.write("					}\r\n");
      out.write("				}\r\n");
      out.write("			})\r\n");
      out.write("		}else{\r\n");
      out.write("			$(\"#ajaxCheck\").html(\"아이디는 영문+숫자 글자 이상입니다.\");\r\n");
      out.write("			$(\"#ajaxCheck\").css(\"color\",\"red\");\r\n");
      out.write("			\r\n");
      out.write("		}\r\n");
      out.write("	})\r\n");
