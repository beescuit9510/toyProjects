		...
		<div class="project-wrap">
			...
			<c:forEach items="${list }" var="f" varStatus="i">
				<section class="project-box moving-top">
					...
					<div class="rate">
						달성률 <span class="percent point">${f.percent }<%-- <fmt:formatNumber value= "${f.rewardPrice*f.total / f.targetPrice * 100 }" pattern = "00" /> --%>%<%-- ${f.rewardPrice*f.total / f.targetPrice * 100 }% --%></span>
					</div>
