 ...
 <c:import url="/WEB-INF/views/common/header.jsp"></c:import>
 	<div class="container">
		...
		<div class="shopping">
				...
				<div class="target">
					<span class="gray">달성률</span><span class="bold"><fmt:formatNumber value= "${fvt.rewardPrice*fvt.total / fvt.targetPrice * 100 }" pattern = "00" />%</span><span class="gray">목표금액 : ${fvt.targetPrice }원</span>
				</div>
				<div class="callender">
