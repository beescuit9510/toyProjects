				...
				for(var i=0;i<ffs.length;i++){
					...
					if(fundedFundings[i].makerboard != null){
						...
						if(ff.Filepath != null){
							...
							html += "<div id='background-url' style='background:url(/upload/project/"+ff.funding.projectBasicInfo.filepath+")';></div>";
						...
						if(ff.projectBasicInfo.filepath){
							...
							html += "<div id='background-url' style='background:url(/upload/funder/"+ff.projectBasicInfo.filepath+")';></div>";
