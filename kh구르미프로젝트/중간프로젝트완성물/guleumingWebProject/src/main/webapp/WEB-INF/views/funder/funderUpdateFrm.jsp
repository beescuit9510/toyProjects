		...
		<div class="funder_add">
			<div class="add_left border_a">
                <div class="profileTop">                   
                    ...
                    <span class="profileName">${sessionScope.member.businessName}</span>
                </div>
			 ...
			 <form action="/funderUpdate" method="post" enctype="multipart/form-data" id="funder_add">
			    <div class="add_right border_a">
                    <table class="table">
                        <tr class="table-active center_list">
                            ...
                            <td class="displayflex">
                                ...
                                <c:choose>
									<c:when test="${not empty mb.profileFilepath}">
										<img id="img-view" class="profile_view" src="/upload/funder/${mb.profileFilepath}">
										<input type="hidden" name="oldFilepath" value="${mb.profileFilepath}">							
									</c:when>
									<c:otherwise>
                        ...
                        <input type="hidden" name="writerNo" value="${sessionScope.member.cMemberNo}">
                        <tr class="table-active">
                            <th>법인명</th>
                            <td><input type="text" name="businessName" class="input_03" value="${sessionScope.member.businessName}" readonly></td>
                        </tr>
                        <tr class="table-active">
                            <th>설립일자</th>
                            <td><input type="text" name="openDate" class="input_03" value="${mb.openDate}" readonly></td>
                        </tr>
                        <tr class="table-active">
                            <th>유사 업종</th>
                            <td>
                        ...
                        <tr class="table-active">
                            <th>문의사항</th>
                            <td>
                                <input type="text" name="boardEmail" class="input_03" placeholder="${mb.boardEmail}">
                            </td>
                        </tr>
                        <tr class="table-active">
                            <th>회사 주소</th>
                                ...
                                <div class="profile_tags">
                                    <ul class="tag_list">
                                    	<c:forTokens items="${mb.searchTag}" delims="/" var="searchtag">
											<li class='tag-item'>${searchtag}<span class='del-btn'><img src="/img/Parksowon/close.png"></span></li>
                                    	</c:forTokens>
                                    </ul>
                        ...
                        <tr class="table-active">
                            <th>회사 소개</th>
                            <td>
                                <textarea name="companyIntro" class="textarea_pro">${mb.companyIntro}</textarea>
                            </td>
                        </tr>
                        <tr class="table-active">
                        	<th>보유 자격증</th>
                        		...
                        		<div class="profile_skill">                        			
                        			<ul class="skill_list">
					                    <c:forTokens items="${mb.skillName}" delims="/" var="skillname">
					                    		<li class='skill_item'> 
						                    		<h2 class='skill_name'>${skillname}</h2>
						                    		<select name='skill_lel'>
							                    		<option value='국가자격증'>국가자격증</option>
							                    		<option value='민간자격증'>민간자격증</option>
						                    		</select><span class='del_skill'>
						                    		<img src="/img/Parksowon/close.png">
						                    		</span>
					                    		</li>
										</c:forTokens>                       				
                        			</ul>
                    ...
                    <div class="next_btn">
                        <button class="btn btn_100" type="button">수정하기</button>
                    </div>
                </div>
            </form>
		</div>
		...
		//태그
		 $(function () {
			...
			$(".next_btn>button").click(function(){
				if (!$("input:checked[name='funderCategory']").is(":checked")){
