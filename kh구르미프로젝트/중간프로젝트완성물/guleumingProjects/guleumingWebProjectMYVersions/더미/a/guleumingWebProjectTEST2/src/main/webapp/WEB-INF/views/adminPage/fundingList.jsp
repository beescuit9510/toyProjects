		...
		<div class="project-wrap">
			...
			<c:forEach items="${list }" var="f" varStatus="i">
				<section class="project-box moving-top">
					...
					<div class="rate">
						달성률 <span class="percent point">${f.projectNo }%</span>
					</div>
					<div class="target-price">
						목표 금액 <span>${f.targetPrice }원</span>
					</div>
					<div class="buttons">
						<button class="btn_sm btn_out Payment-details"><a href="/mypage">결제 내역</a></button>
						<button class="btn_sm btn_out funding-view"><a href="/fundingView?projectNo=${f.projectNo }">펀딩 보러가기</a></button>
					</div>
				</section>
				</c:forEach>
			</div>
